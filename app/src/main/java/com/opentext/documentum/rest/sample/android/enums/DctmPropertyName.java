...
package com.opentext.documentum.rest.sample.android.enums;


public class DctmPropertyName {
    // sysobject
    ...
    public static final String USER_LOGIN_DOMAIN = "user_login_name";
    ...
    public static final String DESCRIPTION_GROUP = "description";
