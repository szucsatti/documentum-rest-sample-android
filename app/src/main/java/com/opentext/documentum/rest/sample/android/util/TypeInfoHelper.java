...
public enum TypeInfoHelper {
    ...
    public static final String SYSOBJECT_VIEW_LIST = "object_name,title,subject,owner_name,r_object_type,r_creation_date,r_modify_date,r_lock_owner,r_object_id";
